  ...
  <div class="blog-section">
    <div class="container">
      ...
      <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
        ...
        <a href="{{ url('/blog' . '/' . $blog->slug)  }} " class="post-thumbnail"><img src="{{ $blog->thumbnail }}"
          alt="Image" class="w-100 img-fluid"></a>
        <div class="post-content-entry">
          <h3><a href=" {{ url('/blog' . '/' . $blog->slug)  }}  ">
            {{ $blog->getTranslations('title')[app()->getLocale()] }}

          </a></h3>
          <div class="meta">
          <span>by <a href="{{ route('blog.author', ["slug"=>$blog->created_by], true, app()->getLocale()) }}"> {{ $blog->created_by }} </a></span> <span>on <a
