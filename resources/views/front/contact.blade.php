<x-mainlayout title="Contact Page">
  <!-- Start Hero Section -->
  <div class="hero">
    <div class="container">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    <label class="text-black" for="fname">Subject</label>
                    <input type="text" class="form-control" value="{{old('subject')}}" name="subject" id="fname">
                  </div>
                </div>
              </div>
          </div>
